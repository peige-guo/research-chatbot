...
export function ActivityTimeline({
  ...
  const getEventIcon = (title: string, index: number) => {
    ...
    if (title.toLowerCase().includes("generating") || title.toLowerCase().includes("generate")) {
    ...
    } else if (title.toLowerCase().includes("finalizing") || title.toLowerCase().includes("final")) {
